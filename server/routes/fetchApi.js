...
FetchRouter.get('/photos', FetchApiController.getRandom)
FetchRouter.get('/collections', FetchApiController.getCollection)
FetchRouter.get('/detailpage/:id', FetchApiController.getDetailPhoto)
